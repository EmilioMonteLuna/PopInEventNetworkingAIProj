...
def ensure_server_running():
    ...
    try:
        # Use the main health endpoint (not prefixed)
...
def create_sample_data():
    """Get existing sample data for visualization"""
    print("📊 Using existing sample data...")

    # Since sample data was created during setup, let's just use it
    # The run_project.py already created 20 users and 5 events
    print("   ✅ Using existing sample data from database initialization")
    return 1  # Use event ID 1

    # Sample data already exists from run_project.py setup
